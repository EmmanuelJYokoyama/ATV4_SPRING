...
public class VendaMolde {
	...
	public Set<Long> getIdMercadorias() { return idMercadorias; }
	public void setIdMercadorias(Set<Long> idMercadorias) { this.idMercadorias = idMercadorias; }

	public Set<Long> getIdServicos() { return idServicos; }
	public void setIdServicos(Set<Long> idServicos) { this.idServicos = idServicos; }
